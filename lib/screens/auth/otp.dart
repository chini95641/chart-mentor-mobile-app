...
//           if (message.body!.contains('chart')) {
...
class _OtpScreenState extends State<OtpScreen> {
  ...
  void readSms() {
    telephony.listenIncomingSms(
      onNewMessage: (SmsMessage message) {
        if (message.body != null && message.body!.contains('chart')) {
          String otpnew = message.body!.substring(0, 6);
          setState(() {
            recieveText = otpnew;
            otp = otpnew;
  ...
  void verifyOtp(String code) async {
    try {
      ...
      // OTP is valid and user is authenticated
      showBottomSheet();
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                Center(
                  child: Text(
                    "Chart mentor would like to allow push notifications?",
